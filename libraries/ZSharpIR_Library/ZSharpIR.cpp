...
int ZSharpIR::distance() {
    ...
    //replacing the coefficient and the power corresponding to your curve
    if (_model==999){
    ...
    else if (_model==20150)//GP2Y0A02YK0F Long-range sensor
	{
...
void ZSharpIR::SetAnalogReadResolution(int res)
{
	...
	//analogReadResolution( res); //commented this based on this --> https://diyprojects.io/proximity-sensor-a02yk0-test-calibration-sharp-gp2y0a02yk0f-asian-clone/#.XHkcOogzbb0
}