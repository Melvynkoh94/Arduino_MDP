...
int readFrontSensor_1() {
  for (int n = 0; n < NUM_SAMPLES_MEDIAN; n++) {
    ...
    frontIR1_Median.add(shortGrid(irDistance, 0, 0, 0));    // add in the array  
...
int readFrontSensor_2() {
  for (int n = 0; n < NUM_SAMPLES_MEDIAN; n++) {
    ...
    frontIR2_Median.add(shortGrid(irDistance, -7, -5, 2));    // add in the array  
...
int readFrontSensor_3() {
  for (int n = 0; n < NUM_SAMPLES_MEDIAN; n++) {
    ...
    frontIR3_Median.add(shortGrid(irDistance, -6, -5, 5));    // add in the array  
...
int readRightSensor_1() {
  for (int n = 0; n < NUM_SAMPLES_MEDIAN; n++) {
    ...
    rightIR1_Median.add(shortGrid(irDistance, -8, -5, 2));    // add in the array  
...
int readRightSensor_2() {
  for (int n = 0; n < NUM_SAMPLES_MEDIAN; n++) {
    ...
    rightIR2_Median.add(shortGrid(irDistance, -4, -2, 0));    // add in the array  
