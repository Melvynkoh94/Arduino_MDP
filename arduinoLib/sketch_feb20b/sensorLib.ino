...
const int NUM_SAMPLES_MEDIAN = 15;  // getting a maximum sample of 15
...
void readFrontSensor_1() {
  double irDistance = frontIR_1.getDistance() - 11;   // for offseting the value for sensor distance
  
  //reference point at 3x3 grid boundary (30cmx30cm) is 0cm
  //anything nearer than that to the IR sensors is still read as 0cm 
  if(irDistance < 0){
    irDistance = 0;
  }
...
void readFrontSensor_3() {
  double irDistance = frontIR_3.getDistance() - 11;
...
void readRightSensor_1() {
  double irDistance = rightIR_1.getDistance() - 10;
...
void readRightSensor_2() {
  double irDistance = rightIR_2.getDistance() - 10;
...
//Real is 17cm, IR gives 20cm reading
//anything nearer than 20cm is rubbish
void readLeftSensor_1() {
  double irDistance = leftIR_1.getDistance() - 3;
