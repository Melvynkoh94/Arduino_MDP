...
const int TICKS[10] = {550, 1190, 1800, 2380, 3020, 3615, 4195, 4775, 5390, 0};  // for movement of each grid
...
void turnLeftDeg(int angle) {
  int index = (angle-20)/5; // index is the index no. of the LEFTTICKS array of size 13
  int tick;
  if (index <= 14)
    tick = LEFTTICK[index];
