...
int readFrontSensor_1() {
  ...
  for (int n=0; n<5; n++) {
    ...
    for (int n = 0; n < NUM_SAMPLES_MEDIAN; n++) {
      double irDistance = frontIR_1.getDistance() - 11;   // for offseting the value for sensor distance (original Thad <-10>)
      //double irDistance = frontIR_1.distance()-9; 
  ...
  for (int n=0; n<5; n++) {
    ...
    for (int n = 0; n < NUM_SAMPLES_MEDIAN; n++) {
      ...
      if (frontIR2_Median.getCount() == NUM_SAMPLES_MEDIAN) {
        if (frontIR2_Median.getHighest() - frontIR2_Median.getLowest() > 30)
          return -10;
  ...
  for (int n=0; n<5; n++) {
    ...
    for (int n = 0; n < NUM_SAMPLES_MEDIAN; n++) {
      ...
      if (rightIR2_Median.getCount() == NUM_SAMPLES_MEDIAN) {
        if (rightIR2_Median.getHighest() - rightIR2_Median.getLowest() > 30)
          return -10;
