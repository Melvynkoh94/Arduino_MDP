...
const int TURN_MAX_SPEED = 260;   //change this to recalibrate rotations
const int ROTATE_MAX_SPEED = 150; //in rotateLeft(int distance), and rotateRight(int distance)
...
//Rotation anti-clockwise on its own axis
void turnLeft() {
  initializeTick();
  initializeMotor_Start();
