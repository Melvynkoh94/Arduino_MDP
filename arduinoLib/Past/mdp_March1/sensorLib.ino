...
//ZSharpIR leftIR_1(A4, 20150); //using ZSharpIR library
...
int readFrontSensor_1() {
  for (int n = 0; n < NUM_SAMPLES_MEDIAN; n++) {
    ...
    frontIR1_Median.add(shortGrid(irDistance, 2, 0, 0));    // add in the array  
...
int readFrontSensor_2() {
  for (int n = 0; n < NUM_SAMPLES_MEDIAN; n++) {
    ...
    frontIR2_Median.add(shortGrid(irDistance, -2, 0, 2));    // add in the array  
...
int readFrontSensor_3() {
  for (int n = 0; n < NUM_SAMPLES_MEDIAN; n++) {
    ...
    frontIR3_Median.add(shortGrid(irDistance, 0, 2, 3));    // add in the array  
...
int readRightSensor_1() {
  for (int n = 0; n < NUM_SAMPLES_MEDIAN; n++) {
    ...
    rightIR1_Median.add(shortGrid(irDistance, -4, 1, 4));    // add in the array  
...
int readRightSensor_2() {
  for (int n = 0; n < NUM_SAMPLES_MEDIAN; n++) {
    ...
    //Serial.println(irDistance);
    rightIR2_Median.add(shortGrid(irDistance, 0, 1, 3));
...
int readLeftSensor_1() {
  ...
  for (int n = 0; n < NUM_SAMPLES_MEDIAN; n++) {
    double irDistance = leftIR_1.getDistance() - 5;   // for offseting the value for sensor distance <-11>
